# PSI3441 - Atividade 2 - PWM e terminal serial (UART)
...
- **Abstração de Hardware:** É obrigatório o uso do **Device Tree (DTS)** e das APIs do Zephyr para acessar os controladores de PWM, evitando o uso de endereços ou pinos fixos (hardcoded) no meio do código principal.
